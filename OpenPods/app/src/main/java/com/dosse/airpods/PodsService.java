                    ...
                    new ScanCallback() {
                        ...
                        public void onScanResult(int callbackType, ScanResult result) {
                            try {
                                ...
                                FileLog.log(PodsService.this, "DECODE DEX", a); // подобным образом можешь использовать практически везде
    ...
    private class NotificationThread extends Thread {
        ...
        public void run() {
            ...
            for (; ; ) {
                ...
                if (notificationShowing) {
                    if (ENABLE_LOGGING)
                        Log.d(TAG, "Left: " + leftStatus + (chargeL ? "+" : "") + " " + "Right: " + rightStatus + (chargeR ? "+" : "") + " " + "Case: " + caseStatus + (chargeCase ? "+" : "") + " " + "Pro: " + pro);
                    if (pro) {
